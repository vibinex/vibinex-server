...
export const generateJWKKeyPair = async (): Promise<KeyPair> => { // Created this function so that in future we can use this to generate keyPair whenever needed. Currently this is not used anywhere.

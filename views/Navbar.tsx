...
const Navbar = (props: { transparent: boolean }) => {
  const chromeExtensionLink =
    "https://chrome.google.com/webstore/detail/vibinex/jafgelpkkkopeaefadkdjcmnicgpcncc";
  ...
  return (
    <AppBar
      position="fixed"
      className="mx-auto p-4 justify-between items-center max-w-7xl"
      backdropClassName={
        "ease-in duration-300" +
        (scrollDown || !props.transparent
          ? " bg-background text-foreground"
          : " bg-black text-foreground text-primary-light border-b-0")
      }
    >
      <Link href="/" className="flex items-center">
        <Image
          ...
          priority
        ></Image>
        <h1 className="font-bold text-3xl sm:text-4xl">Vibinex</h1>
      </Link>
      <ul className="hidden sm:flex sm:items-center sm:justify-evenly">
        ...
        <li id="contribute-link" className="p-3 lg:p-4">
          <Link href="https://github.com/Alokit-Innovations" target="blank">
            Contribute
          </Link>
        </li>
      ...
      <Button
        ...
        className={
          ...
          (showNavbar || scrollDown || !props.transparent
      ...
      >
        <ul>
          <li
            id="docs-link"
            className="p-4 text-4xl text-primary-foreground hover:text-secondary-light"
          >
            <Link href="/docs">Docs</Link>
          </li>
          <li
          ...
          <li
            ...
            className="p-4 text-primary-foreground hover:text-secondary-light"
          >
            <LoginLogout />
          </li>
        </ul>

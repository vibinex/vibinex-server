...
const DropZone = ({ data, dispatch }) => {
    ...
    return (
        <div>
            <div
                className='bg-gray-200 p-3 h-[10rem] rounded-lg my-2 items-center flex justify-center'
            ...
            <label htmlFor="selectFile" className='bg-blue-500 text-white p-2 rounded-lg cursor-pointer'>
                Choose File
            ...
            <button onClick={() => uploadFiles()} className='bg-black text-white p-2 rounded-lg'>Upload file</button>
            </div>

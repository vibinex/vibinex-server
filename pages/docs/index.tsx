...
const verifySetup = [
	"In case of self-hosting for Github provider, please visit <a href='https://vibinex.com/u' style='color: blue; text-decoration: underline;'>https://vibinex.com/u</a> to cross-check if correct repositories have been processed by vibinex-DPU. If not, then please setup the DPU again.",
